...
int find_moves_castles_testLauncher()
{
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        20,
        new Board("5rk1/8/5P2/8/8/8/8/8 b f - 0 1"),
        requested_moves,
        11
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        21,
        new Board("1kr5/8/2P5/8/8/8/8/8 b ac - 0 1"),
        requested_moves,
        11
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        210,
        new Board("2rk4/8/2P5/8/8/8/8/8 b c - 0 1"),
        requested_moves,
        8
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        211,
        new Board("5kr1/8/6P1/8/8/8/8/8 b g - 0 1"),
        requested_moves,
        7
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        23,
        new Board("8/8/8/8/8/5p1p/8/5RKR w FH - 0 1"),
        requested_moves,
        12
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        24,
        new Board("8/8/8/8/8/p1p5/8/RKR5 w AC - 0 1"),
        requested_moves,
        12
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        241,
        new Board("8/8/8/8/8/2p5/8/2RK4 w C - 0 1"),
        requested_moves,
        8
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        242,
        new Board("8/8/8/8/8/6p1/8/5KR1 w G - 0 1"),
        requested_moves,
        7
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        27,
        new Board("r3k2R/8/8/8/8/8/8/8 b a - 0 1"),
        requested_moves,
        3
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        28,
        new Board("8/8/8/8/8/8/8/R3K2r w a - 0 1"),
        requested_moves,
        3
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        29,
        new Board("5rk1/8/2R2P2/8/8/8/8/8 b f - 0 1"),
        requested_moves,
        10
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        30,
        new Board("rkr5/8/R1R3R1/8/8/8/8/8 b ac - 0 1"),
        requested_moves,
        10
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        31,
        new Board("8/8/8/8/8/p1p3r1/8/RKR5 w AC - 0 1"),
        requested_moves,
        11
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        32,
        new Board("r3k2r/8/P2R1R1P/8/8/8/8/8 b ah - 0 1"),
        requested_moves,
        10
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        33,
        new Board("8/8/8/8/8/p2r1r1p/8/R3K2R w AH - 0 1"),
        requested_moves,
        10
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        34,
        new Board("r2pkp1r/8/P6P/8/8/8/8/8 b ah - 0 1"),
        requested_moves,
        12
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        35,
        new Board("rp2k2r/8/P6P/8/8/8/8/8 b ah - 0 1"),
        requested_moves,
        13
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        36,
        new Board("8/8/8/8/8/p6p/8/R2pKp1R w AH - 0 1"),
        requested_moves,
        14
    );
    ...
    success_count += find_moves_RegularCases_FindAllMoves(
        36,
        new Board("8/8/8/8/8/p6p/8/Rp2K2R w AH - 0 1"),
        requested_moves,
        13
    );
