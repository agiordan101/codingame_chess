...
class StockfishBot(AbstractBot):
    ...
    def __init__(self, ELO: int = 1000, time_per_turn: int = None):
        ...
        self.stockfish_path = (
            "/home/antoine/stockfish/stockfish/stockfish-ubuntu-x86-64-avx2"
        )
        self.parameters = {
            "Debug Log File": "",
            "Contempt": 0,
        ...
        self.stockfish = stockfish.Stockfish(
            path=self.stockfish_path, parameters=self.parameters
        )

    def __str__(self) -> str:
        return (
            f"StockfishBot(ELO={self.parameters['UCI_Elo']},TPT={self.time_per_turn}ms)"
        )
