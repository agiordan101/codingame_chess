...
/*
        Content of 'srcs/heuristics/BestHeuristic.hpp'
*/
...
class BestHeuristic : public AbstractHeuristic
{
    ...
    private:
        ...
        const int check_bonus = 2 * (float)PAWN_VALUE / 10;
...
vector<string> MinMaxAlphaBetaAgent::get_stats()
{
    ...
    stats.push_back("version=BbMmabBh-25ms-12.1.2");
    stats.push_back("depth=" + to_string(this->_depth_reached));
    stats.push_back("states=" + to_string(this->_nodes_explored));
    cerr << "BbMmabBh-25ms-12.1.2\t: stats=" << stats[0] << " " << stats[1] << " " << stats[2]
         << endl;
    return stats;
}
...
/*
        Content of 'srcs/heuristics/BestHeuristic.cpp'
*/
