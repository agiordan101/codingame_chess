...
class Board
{
        ...
        */
        ...
        bool white_turn;
        int castles[4]; // Rook column index where the castle is available - 2 first for White and 2
                        // last for Black
        int kings_initial_columns[2]; // First for white king and second for black king
        int en_passant_x; // En passant coordinates & availability are created after a pawn move of
                          // 2 squares
        int  en_passant_y;
