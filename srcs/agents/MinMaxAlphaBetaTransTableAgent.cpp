...
MinMaxAlphaBetaTransTableAgent::MinMaxAlphaBetaTransTableAgent(AbstractHeuristic *heuristic, int ms_constraint)
{
...
)
{
    ...
    if (dtime >= _ms_constraint)
        cerr << "MinMaxAlphaBetaTransTableAgent: TIMEOUT: dtime=" << dtime << "/" << this->_ms_constraint
             << "ms" << endl;
}
...
{
    return "MinMaxAlphaBetaTransTableAgent[" + to_string(this->_ms_constraint) + "ms]." +
           this->_heuristic->get_name();
}

float MinMaxAlphaBetaTransTableAgent::minmax(Board *board, int max_depth, int depth, int zobrist_key)
{
...
float MinMaxAlphaBetaTransTableAgent::max_node(Board *board, int max_depth, int depth, s_MinMaxNode *node)
{
...
float MinMaxAlphaBetaTransTableAgent::min_node(Board *board, int max_depth, int depth, s_MinMaxNode *node)
{
